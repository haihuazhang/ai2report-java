sap.ui.define([
    ...
    "../service/ChatService"
], function (BaseController, ODataListBinding, NewEntityDialog, UI5Event, ListItemBase, Container, ChatService) {
    "use strict";

    return BaseController.extend("chatbotui2.controller.Chats", {
        ...
        onBtnParameter: function () {
            Container.getServiceAsync("Navigation").then((Navigation) => {
                Navigation.navigate({
                    target: {
                        semanticObject: "parameter", action: "display"
                    }
                });
            });
        }
