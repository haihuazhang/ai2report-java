...
@Beta
public class ClaudeAiChatCompletionDelta extends ClaudeAiCompletionOutput implements StreamedDelta {
  /** List of result candidates. */
  @JsonProperty("choices")
  @Getter(onMethod_ = @Nonnull)
  private List<ClaudeAiDeltaChatCompletionChoice> choices;
