...
@ToString
@Beta
public class ClaudeAiCompletionChoice {
  /**
  ...
  void addDelta(@Nonnull final ClaudeAiCompletionChoice delta) {
    ...
    if (delta.getContentFilterResults() != null) {
      if (contentFilterResults == null) {
        contentFilterResults = new ClaudeAiContentFilterPromptResults();
      }
