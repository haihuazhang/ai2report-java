...
import customer.aireport.service.SAPAICore.claude.model.ClaudeAiChatMessage.ClaudeAiChatFunctionMessage;
import customer.aireport.service.SAPAICore.claude.model.ClaudeAiChatMessage.ClaudeAiChatSystemMessage;
import customer.aireport.service.SAPAICore.claude.model.ClaudeAiChatMessage.ClaudeAiChatToolMessage;
...
@JsonTypeInfo(use = Id.NAME, property = "role", defaultImpl = ClaudeAiChatAssistantMessage.class)
// role is the field that determines the class type
// if role is missing we default to ClaudeAiChatAssistantMessage
@JsonSubTypes({
  @Type(value = ClaudeAiChatSystemMessage.class, name = "system"),
  @Type(value = ClaudeAiChatUserMessage.class, name = "user"),
  @Type(value = ClaudeAiChatAssistantMessage.class, name = "assistant"),
  @Type(value = ClaudeAiChatToolMessage.class, name = "tool"),
  @Type(value = ClaudeAiChatFunctionMessage.class, name = "function")
})
@Beta
public interface ClaudeAiChatMessage {
  /**
  ...
  // @EqualsAndHashCode
  // @ToString
  // class ClaudeAiChatSystemMessage implements ClaudeAiChatMessage {
  //   /** The role of the messages author. */
  ...
  @EqualsAndHashCode
  @ToString
  class ClaudeAiChatUserMessage implements ClaudeAiChatMessage {
    /** The role of the messages author. */
    @Getter(onMethod_ = @Nonnull)
     ...
     */
    @Nonnull
    public ClaudeAiChatUserMessage addText(@Nonnull final String content) {
     ...
     */
    @Nonnull
    public ClaudeAiChatUserMessage addImage(@Nonnull final String content) {
     ...
     */
    @Nonnull
    public ClaudeAiChatUserMessage addImage(
     ...
     */
    @Nonnull
    public ClaudeAiChatUserMessage addContent(@Nonnull final ContentPart... content) {
  ...
  @EqualsAndHashCode
  @ToString
  class ClaudeAiChatAssistantMessage implements ClaudeAiChatMessage {
    /** The role of the messages author. */
    @Getter(onMethod_ = @Nonnull)
    ...
    @Getter(onMethod_ = @Nullable)
    private List<ClaudeAiChatToolCall> toolCalls;
    ...
    void addDelta(@Nonnull final ClaudeAiChatAssistantMessage delta) {
  ...
  @EqualsAndHashCode
  @ToString
  class ClaudeAiChatToolMessage implements ClaudeAiChatMessage {
    /** The role of the messages author. */
    @Getter(onMethod_ = @Nonnull)
  ...
  @EqualsAndHashCode
  @ToString
  class ClaudeAiChatFunctionMessage implements ClaudeAiChatMessage {
    /** The role of the messages author. */
    @Getter(onMethod_ = @Nonnull)
