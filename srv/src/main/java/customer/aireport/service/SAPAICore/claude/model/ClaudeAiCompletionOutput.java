...
@ToString
@Beta
public class ClaudeAiCompletionOutput {
  ...
  private ClaudeAiUsage usage;

  /** Content filtering results for zero or more prompts in the request. */
  @JsonProperty("prompt_filter_results")
  @Getter(onMethod_ = @Nullable)
  private List<ClaudeAiPromptFilterResult> promptFilterResults;

  void addDelta(@Nonnull final ClaudeAiChatCompletionDelta delta) {
