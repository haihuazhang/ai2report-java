...
import customer.aireport.service.SAPAICore.claude.model.ClaudeAiChatCompletionOutput;
import customer.aireport.service.SAPAICore.claude.model.ClaudeAiChatCompletionParameters;
import customer.aireport.service.SAPAICore.claude.model.ClaudeAiChatMessage.ClaudeAiChatSystemMessage;
import customer.aireport.service.SAPAICore.claude.model.ClaudeAiChatMessage.ClaudeAiChatUserMessage;
import customer.aireport.service.SAPAICore.claude.model.ClaudeAiEmbeddingOutput;
import customer.aireport.service.SAPAICore.claude.model.ClaudeAiEmbeddingParameters;
...
public final class ClaudeAiClient {
   ...
   * with basic string prompts {@link #streamChatCompletionDeltas(ClaudeAiChatCompletionParameters)}.
   *
   ...
   */
  @Nonnull
  public ClaudeAiChatCompletionOutput chatCompletion(@Nonnull final String prompt)
      throws ClaudeAiClientException {
    final ClaudeAiChatCompletionParameters parameters = new ClaudeAiChatCompletionParameters();
    if (systemPrompt != null) {
      // parameters.addMessages(new ClaudeAiChatSystemMessage().setContent(systemPrompt));
  ...
  public ClaudeAiChatCompletionResponse chatCompletion(
      @Nonnull final ClaudeAiChatCompletionRequest request) throws ClaudeAiClientException {
  ...
  public CreateChatCompletionResponse chatCompletion(
      @Nonnull final CreateChatCompletionRequest request) throws ClaudeAiClientException {
    // return execute("/chat/completions", request, CreateChatCompletionResponse.class);
    return execute("/invoke", request, CreateChatCompletionResponse.class);
  }
  ...
  public ClaudeAiChatCompletionOutput chatCompletion(
      @Nonnull final ClaudeAiChatCompletionParameters parameters) throws ClaudeAiClientException {
    // warnIfUnsupportedUsage();
    // return execute("/chat/completions", parameters, ClaudeAiChatCompletionOutput.class);
  ...
  //  * individual chunks, use {@link #streamChatCompletionDeltas(ClaudeAiChatCompletionRequest)}.
  //  *
  ...
  //  * @throws ClaudeAiClientException if the request fails or if the finish reason is content_filter
  ...
  //   final var request =
  //       systemPrompt != null
  //           ? new ClaudeAiChatCompletionRequest(ClaudeAiMessage.system(systemPrompt), userPrompt)
  ...
  // private static void throwOnContentFilter(@Nonnull final ClaudeAiChatCompletionDelta delta) {
  ...
  //  * @return A stream of message deltas
  //  * @throws ClaudeAiClientException if the request fails or if the finish reason is content_filter
  //  * @see #streamChatCompletionDeltas(ClaudeAiChatCompletionRequest) for a higher-level API
  //  * @since 1.4.0
  //  */
  // @Beta
  // @Nonnull
  ...
  //   // return executeStream("/chat/completions", request, ClaudeAiChatCompletionDelta.class);
  ...
  //  */
  // @Nonnull
  // public Stream<customer.aireport.service.SAPAICore.claude.model.ClaudeAiChatCompletionDelta>
  //     streamChatCompletionDeltas(@Nonnull final ClaudeAiChatCompletionParameters parameters)
  //         throws ClaudeAiClientException {
  //   // warnIfUnsupportedUsage();
  ...
  // @Beta
  // @Nonnull
  // public ClaudeAiEmbeddingResponse embedding(@Nonnull final ClaudeAiEmbeddingRequest request)
  //     throws ClaudeAiClientException {
  //   return new ClaudeAiEmbeddingResponse(embedding(request.createEmbeddingsCreateRequest()));
  // }
  ...
  //  */
  // @Nonnull
  // public ClaudeAiEmbeddingOutput embedding(@Nonnull final ClaudeAiEmbeddingParameters parameters)
  //     throws ClaudeAiClientException {
  ...
  private <D extends StreamedDelta> Stream<D> streamRequest(
    ...
    try {
      final var client = ApacheHttpClient5Accessor.getHttpClient(destination);
      return new ClientStreamingHandler<>(deltaType, ClaudeAiError.class, ClaudeAiClientException::new)
