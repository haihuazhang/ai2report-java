...
/**
 * Represents an image item in a {@link ClaudeAiMessageContent} object.
 *
 ...
 */
@Beta
public record ClaudeAiImageItem(@Nonnull String imageUrl, @Nonnull DetailLevel detailLevel)
    implements ClaudeAiContentItem {
   ...
   * @param imageUrl the URL of the image
   */
  public ClaudeAiImageItem(@Nonnull final String imageUrl) {
